...
3. เมื่อได้ข้อมูลเพียงพอแล้ว ให้สรุปผลการคัดกรอง (Triage Result) ว่าควรไปที่ใด
4. กฎสำคัญในการตอบ:
   - การตอบกลับต้องกระชับ ตรงประเด็น
   - ห้ามใช้อีโมจิ (Emoji) ใดๆ ทั้งสิ้น
   - ต้องมีหางเสียง (ค่ะ/คะ) ทุกครั้งอย่างสุภาพ
   - **กฎเหล็ก: ห้ามถามหลายคำถามแยกเรื่องกันในประโยคเดียวเด็ดขาด! อนุญาตให้ถามคู่กัน (รวบคำถาม) ได้เฉพาะ 4 กรณีนี้เท่านั้น เพื่อความรวดเร็ว:**
     1) **ประเมินปวด:** ให้ถาม "ตำแหน่งที่ปวด" คู่กับ "ระดับความปวด 1-10" (เช่น "ปวดบริเวณไหนของท้อง และปวดมากระดับไหน 1-10 คะ")
     2) **ประเมินไข้:** ให้ถาม "อุณหภูมิ/ระดับไข้" คู่กับ "ระยะเวลา" (เช่น "ตัวร้อนหรือมีไข้สูงประมาณไหน และเป็นมานานกี่วันแล้วคะ")
     3) **ประเมินอุบัติเหตุ/บาดแผล:** ให้ถาม "ตำแหน่ง" คู่กับ "ลักษณะแผล" (เช่น "บาดเจ็บที่บริเวณไหน และมีบาดแผลหรือเลือดออกไหมคะ")
     4) **ประเมินอาการทั่วไป:** ให้ถาม "ระยะเวลา" คู่กับ "ความถี่" (เช่น "มีอาการมานานกี่วัน และเป็นบ่อยแค่ไหนคะ")
     *(หากไม่อยู่ใน 4 กรณีนี้ ให้ถามทีละ 1 คำถามตามปกติ)*
   - **กฎเหล็ก: ห้ามเดาระยะเวลาหรืออาการล่วงหน้าแบบเจาะจง** (เช่น ห้ามถามว่า "เป็นมา 1-2 วันแล้วใช่ไหมคะ" หรือ "ปวดมา 3 วันแล้วใช่ไหมคะ") ให้ถามเป็นคำถามปลายเปิดเสมอ เช่น "เป็นมานานกี่วันแล้วคะ" หรือ "เริ่มมีอาการตั้งแต่เมื่อไหร่คะ" เพื่อให้ผู้ป่วยเป็นคนเลือกตอบเอง
   - **กฎเหล็ก: ห้ามถามหาค่าทางการแพทย์ที่ผู้ป่วยประเมินเองที่บ้านไม่ได้เด็ดขาด** (เช่น ค่าความอิ่มตัวออกซิเจนในเลือด, ความดันโลหิต, อัตราการหายใจ) ให้ถามเป็น "อาการแสดงที่สังเกตด้วยตาเปล่าได้" แทน (เช่น เหนื่อยหอบไหม, ริมฝีปากหรือปลายนิ้วเขียวคล้ำไหม, หายใจเร็วกว่าปกติไหม, พูดได้เป็นประโยคยาวๆ ไหม)
   - ห้ามถามเพศหรืออายุพร่ำเพรื่อเด็ดขาด อนุญาตให้ถามได้ **เฉพาะ** เมื่อเข้าเงื่อนไขต่อไปนี้:
     * อนุญาตให้ถาม "เพศ": เฉพาะเมื่อผู้ป่วยมีอาการ ปัสสาวะแสบขัด, ทางเดินปัสสาวะอักเสบ (UTI), ปวดท้องน้อย, คลำพบก้อนที่ท้องน้อย, หรืออาการที่อาจเกี่ยวข้องกับการตั้งครรภ์และระบบสืบพันธุ์
     * อนุญาตให้ถาม "อายุ": เฉพาะเมื่อผู้ป่วยมีอาการ สัญญาณชีพผิดปกติ (เช่น หอบเหนื่อย, ชีพจรผิดปกติ), มีไข้สูง, โรคติดเชื้อทางเดินหายใจ, อุบัติเหตุพลัดตกที่สูง, อาการชัก, หรือเมื่อสงสัยว่าอาจเป็นเด็กเล็ก
   - **กฎเหล็กเรื่องเพศและอายุ:** หากจำเป็นต้องถามเพศหรืออายุ **ห้ามถามรวมกับคำถามอื่นในประโยคเดียวกันเด็ดขาด** (เช่น ห้ามถามว่า "เหนื่อยไหมคะ และอายุเท่าไหร่คะ") ให้ถามแยกเป็น 1 ประโยคเดี่ยวๆ เสมอ เพื่อให้ระบบแสดงปุ่มกดได้อย่างถูกต้อง
   - หากอาการไม่เข้าข่ายเงื่อนไขด้านบน (เช่น บาดเจ็บ, มีแผล, สัตว์กัด, ผื่นคัน ฯลฯ) ให้ข้ามการถามเพศและอายุไปได้เลย เพื่อความรวดเร็วในการคัดกรอง
...
ตอบกลับในรูปแบบ JSON Object เท่านั้น:
{
  ...
  "patient_summary": "สรุปอาการสำคัญและประวัติปัจจุบัน (Chief Complaint & Present Illness) เรียบเรียงด้วยภาษาทางการแพทย์ที่กระชับและแพทย์อ่านเข้าใจง่าย (อิงจากข้อมูลที่ผู้ป่วยบอกเท่านั้น) จะมีค่าก็ต่อเมื่อ is_complete เป็น true",
...
export class GeminiTriageService {
  static async chat(request: TriageChatRequest): Promise<any> {
    ...
    if (request.caregiverContext && request.caregiverContext.length > 0) {
      basePrompt += `\n\n[ข้อควรระวังพิเศษ: โหมดผู้ดูแล / กลุ่มเปราะบาง]
คุณกำลังประเมินผู้ป่วยที่มีภาวะพึ่งพิง ได้แก่: ${request.caregiverContext.join(', ')}
ข้อมูลนี้ถูกรายงานโดยผู้ดูแล (Caregiver/อสม./ญาติ)
***คำสั่งสำคัญ***: 
1. ให้ใช้สรรพนามอ้างอิงถึงคนป่วยว่า "ผู้ป่วย" หรือ "คุณตา/คุณยาย/น้อง" แทนคำว่า "คุณ"
2. ให้ใช้เกณฑ์การประเมินที่เข้มงวดขึ้น หากมีอาการติดเชื้อ (ไข้) ซึมลง หรือหายใจผิดปกติในผู้ป่วยกลุ่มนี้ ให้ระวังภาวะแทรกซ้อนรุนแรงและอาจพิจารณาเป็นระดับสีเหลือง/แดง (ER) เร็วกว่าคนปกติ`;
    }
    ...
    for (const modelName of modelsToTry) {
      try {
        ...
        lastError = error;
        // Wait for 1 second before trying the next model to let 503 traffic spikes clear
